...
final class Store: ObservableObject {
    ...
    private let fileName = "refillage_entries.json"
    ...
    static func seedData() -> [Entry] {
        let now = Date()
        return [
            Entry(title: "Sample Supply One", detail: "First example entry.", date: now),
            Entry(title: "Sample Supply Two", detail: "Second example entry.", date: now.addingTimeInterval(-86400)),
            Entry(title: "Sample Supply Three", detail: "Third example entry.", date: now.addingTimeInterval(-172800)),
        ]
    }
}
